document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (field.type === 'email' && !isValidEmail(value)) {
          ...
          errorMessage = formatFieldName(fieldName) + ' must be at least ' + field.minLength + ' characters.';
        } else if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
          errorMessage = formatFieldName(fieldName) + ' must not exceed ' + field.maxLength + ' characters.';
        }
      }
  ...
  // Auto-detect and animate common section elements if no explicit animate classes found
  if (animatableElements.length === 0) {
    const autoSelectors = [
      '.section-title',
      '.section-subtitle',
    ...
    const autoElements = document.querySelectorAll(autoSelectors.join(', '));

    if ('IntersectionObserver' in window && autoElements.length > 0) {
      ...
      autoElements.forEach(function (el, index) {
        el.classList.add('scroll-hidden');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בושם משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'd8650646-c460-4281-bd11-012f9ff6ba42',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'd8650646-c460-4281-bd11-012f9ff6ba42';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd8650646-c460-4281-bd11-012f9ff6ba42';
